<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" v-show="showSearch" label-width="80px">
      <el-row>
          <el-col :span="24">
            <el-form-item label="客戶" prop="tradeId">
        <!-- <el-select v-model="queryParams.tradeId" placeholder="请选择客户" clearable size="small">
          <el-option
          ...
          />
              ...
              <treeselect v-model="form.tradeId" :options="deptOptions" :normalizer="normalizer" style="width:30%" placeholder="请选择客户" />
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd" >数据更新</el-button><!-- v-hasPermi="['commanage:iotcard:add']" -->
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate" >批量充值</el-button><!-- v-hasPermi="['commanage:iotcard:edit']" -->
      </el-col>
    ...
    <el-table v-loading="loading" :data="iotCardList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="基础套餐" align="center" prop="baseMeal" />
      <el-table-column label="流量总量(M)" align="center" prop="flowTotal" />
      <el-table-column label="流量用量(M)" align="center" prop="flowUsed" />
      ...
      <el-table-column label="失效时间" align="center" prop="unusedTime" width="100">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.createTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
